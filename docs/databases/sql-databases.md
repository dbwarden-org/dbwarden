...
RENAME COLUMN        (2)
ALTER COLUMN TYPE    (3)
ALTER COLUMN NULLABLE (4)
ALTER COLUMN DEFAULT (5)
CREATE TYPE          (6)
CREATE FUNCTION      (6)
CREATE TABLE         (7)
CREATE VIEW          (8)
ADD COLUMN           (9)
ALTER FOREIGN KEY    (10)
DROP VIEW            (11)
ALTER INDEX          (12)
DROP COLUMN          (13)
DROP TABLE           (14)
ALTER TABLE COMMENT  (15)
ALTER COLUMN COMMENT (16)
ALTER TABLE OPTIONS  (17)
ALTER TABLE CONSTRAINT (18)
```
